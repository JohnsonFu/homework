...
<div id="top_bg">
    ...
    <div id="menu">
        <ul >
            ...
            <li><a href="#" style="color:#9eff9d;">社交</a></li>
...
<div id="leftbar">
    ...
    <div id="vertmenu">
        <ul>
            <li><a href="friend.php" style=" color: #daddf0; background-color: #80c3f7;" >互相关注</a></li>
...
<div id="content">
    <div class="insidecontent">
        <div class="mylabel">互相关注</div><hr style="margin-right: 50px;">
